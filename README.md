...
A lightweight campus messaging system built in C++ that combines TCP and UDP protocols for reliable communication and real-time notifications. Perfect for learning network programming, multi-threading, and building a scalable messaging server.
